...
namespace test.Test
{
    ...
    public class TheBucketFeatureSteps
    {
        ...
        public void WhenListMultipartUploadsWithPrefix()
        {
            ScenarioContext.Current.Pending();
        }
        ...
        [Then(@"list multipart uploads with prefix count is (.*)")]
        public void ThenListMultipartUploadsWithPrefixCountIs(int p0)
        {
            ScenarioContext.Current.Pending();
        }
    }
