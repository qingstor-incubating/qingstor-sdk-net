...
namespace QingStor_SDK_CSharp.Service
{
	...
	public class CCloudfuncArgsType : ICustomType
	{
		// Required
	...
	public string key_seprate { get; set; }

		
		
	public string save_bucket { get; set; }
	...
	public class CFilterType : ICustomType
	{
	...
	public string cloudfunc { get; set; }

		
		
	public CCloudfuncArgsType cloudfunc_args { get; set; }
	...
	public class CRuleType : ICustomType
	{
		
		
		
	public CAbortIncompleteMultipartUploadType abort_incomplete_multipart_upload { get; set; }

		
		
	public CExpirationType expiration { get; set; }
// Required
		
		
	public CFilterType filter { get; set; }
	...
	public CTransitionType transition { get; set; }
